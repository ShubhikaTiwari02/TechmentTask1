package com.techment.day13.StreamTask;
...
public class StreamTask {
	...
	public static void main(String[] args) {
		...
		Employee employee1 = new Employee(1, "shubhika", "Tiwari", "shubhika2@gmail.com", "9999124572",
				new SimpleDateFormat("dd/MM/yyyy").parse("11/11/2020"), "senior hr", 22000, 100, department1);
		Employee employee2 = new Employee(2, "shilvee", "tiwari", "shilvee@gmail.com", "7630344572",
				new SimpleDateFormat("dd/MM/yyyy").parse("22/02/2019"), "manager hr", 35000, 101, department2);
		Employee employee3 = new Employee(3, "rahul", "mishra", "rahul@gmail.com", "8630124572",
		...
		StreamTask mainStream = new StreamTask();
